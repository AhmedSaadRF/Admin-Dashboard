...
export default function SideBar({ open, handleDrawerClose }) {
  ...
  return (
    <Drawer variant="permanent" open={open}>
      ...
      <Divider />
      <Avatar sx={{ mx: 'auto', width: 88, height: 88, my: 1, border: '2px solid grey' }} alt="Remy Sharp" src="/static/images/avatar/1.jpg" />
      <Typography align='center' variant="body1">Ahmed Saad</Typography>
